...
public final class FieldView {
    ...
    public static TelemetryPacket packetP = new TelemetryPacket();
    ...
    public static void renderRobot(double robotX, double robotY, double robotYaw) {
        ...
        double[] currentPosition = {robotY, -robotX};
        trajectoryHistory.add(currentPosition);
...
//        drawTrajectory(packet);
    ...
    public static void renderGoal(double xGoal, double yGoal) {
        packetP.field().setFill("white");
        packetP.field().fillCircle(xGoal, yGoal, 5);
    }
