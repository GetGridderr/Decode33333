...
public class OdometerPinpoint extends Device {
    ...
    public void initialize(HardwareMap hardwareMap) {
        ...
        pinpoint.setOffsets(pinpointConfig.xOffset, pinpointConfig.yOffset, DistanceUnit.MM);
    ...
    public void setOffset(double x, double y) {
        pinpointConfig.xOffset = x;
        pinpointConfig.yOffset = y;
        pinpoint.setOffsets(x, y, DistanceUnit.MM);
    }

    public void setPosition(double x, double y, double heading) {
        Pose2D position = new Pose2D(DistanceUnit.CM, x, y, AngleUnit.DEGREES, heading);
    ...
    public double getSpeedYaw() { return  pinpoint.getHeadingVelocity(UnnormalizedAngleUnit.DEGREES); }
